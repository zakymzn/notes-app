    ...
    <div>
      ...
      <section id="features" className="bg-gray-200">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-16">
          <li data-aos="flip-left" data-aos-delay="100" data-aos-duratoin="1000" className="bg-gray-200 grid grid-cols-2 border-4 border-black rounded-2xl m-4 p-4 space-x-4 space-y-4 items-center">
            <div>
          ...
          <li data-aos="flip-left" data-aos-delay="200" data-aos-duratoin="1000" className="bg-gray-200 grid grid-cols-2 border-4 border-black rounded-2xl m-4 p-4 space-x-4 space-y-4 items-center">
            <div>
          ...
          <li data-aos="flip-left" data-aos-delay="300" data-aos-duratoin="1000" className="bg-gray-200 grid grid-cols-2 border-4 border-black rounded-2xl m-4 p-4 space-x-4 space-y-4 items-center">
            <div>
          ...
          <li data-aos="flip-left" data-aos-delay="400" data-aos-duratoin="1000" className="bg-gray-200 grid grid-cols-2 border-4 border-black rounded-2xl m-4 p-4 space-x-4 space-y-4 items-center">
            <div>
